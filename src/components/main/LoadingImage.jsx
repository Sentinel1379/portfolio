export default function LoadingImage() {
  return (
    <>
        <div className="animate-pulse size-full">
          <div className="size-full flex items-center justify-center bg-gray-300 dark:bg-gray-400">
            <svg
              viewBox="0 0 16 20"
              fill="currentColor"
              xmlns="http://www.w3.org/2000/svg"
              aria-hidden="true"
              className="w-40 h-40 text-gray-200 dark:text-gray-600"
            >
